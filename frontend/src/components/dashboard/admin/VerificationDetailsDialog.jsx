// components/dashboard/admin/VerificationDetailsDialog.js
import {
    Dialog,
    DialogContent,
    DialogHeader,
              ...
              <>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      {verification.address_proofs?.map((proof, index) => (
              ...
              <>
                <div className="space-y-4">
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      {verification.company_docs?.map((doc, index) => (
                        <div key={index} className="border rounded-md p-4">
                          <img
                            src={`/storage/${doc}`}
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      {verification.business_licenses?.map((license, index) => (
                        <div key={index} className="border rounded-md p-4">
                          <img
                            src={`/storage/${license}`}
